...
import type { MPHMinter } from "../MPHMinter";

export class MPHMinter__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MPHMinter {
    return new Contract(address, _abi, signerOrProvider) as MPHMinter;
  }
}
...
const _abi = [
  ...
  },
  {
    ...
    name: "poolDepositorRewardMultiplier",
    outputs: [
      {
        internalType: "uint256",
        name: "",
